...
import { User, Award, Clock, Sun, Moon, Database, Upload, Download, CheckCircle, AlertCircle, LogOut } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-100 dark:border-slate-700/50 shadow-xs space-y-4">
            ...
            <button
              onClick={() => {
                if (window.confirm('Apakah Ibu yakin ingin keluar dari akun ini?')) {
                  logoutUser();
                }
              }}
